...
import { toDayMonth, toHourMinutes } from 'utils/weather/time/converters';
        ...
        {city.daily.map((day, index) => {
          ...
          return (
            <S.Item key={day.timestamp.toString()}>
              <S.ItemDetail>
                <WeatherIcon icon={day.weatherIcon} style={{ fontSize: '1.33em' }} />
              </S.ItemDetail>
              ...
              <S.ItemDetailsList>
                <S.Icon>
                  <FontAwesomeIcon icon={faTint} style={{ fontSize: '1.33em' }} />
                </S.Icon>
                <S.IconDescription>{`${day.humidity}%`}</S.IconDescription>

                <S.Icon>
                  <FontAwesomeIcon icon={faThermometerHalf} style={{ fontSize: '1.33em' }} />
                </S.Icon>
                <S.IconDescription>
                ...
                <S.Icon>
                  <WeatherIcon wind icon={day.wind.icon} style={{ fontSize: '1.33em' }} />
                </S.Icon>
                <S.IconDescription>
