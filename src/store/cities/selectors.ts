...
// city selectors
export const getSelectedCity = (state: State): (City & Weather) | null => state.selectedCity.data;
...
export const getFeaturedCities = (state: State): City[] => state.featuredCities.data;
